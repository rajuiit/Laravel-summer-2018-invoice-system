...
class returnController extends Controller
{
    ...
    public function returnpage($voucherNo)
    {
        ...
        $totalBill = DB::table('deleveredproduct')->where('voucherNo', $voucherNo)->value('sellingPrice');
        ...
        return view('return')->withTotalBill($totalBill)->withBrand($brand)->withModel($model)->withCustomer($customer)->withVoucherNo($voucherNo)->withCustomerName($customerName)->withVoucherDiscount($voucherDiscount)->withPayment($payment)->withDate($date)->withMainDate($mainDate)->withShowingDate($showingDate);
    ...
    {
        // --------Return cart data fetch step (Step 1)------------------------------------
 ...
 */
    ...
    function cusInfoTracking($name)
    {
        ...
        echo "
                    ...
                    <div class=\"total\">
                        <p class=\"alert alert-success\"><b> Current Price   : <span class='current-slog'>$currentPrice tk</span></b></p>
                     </div>
                    <div class=\"prv - due\">
                    ...
                    <div class=\"total\">
                        <p class=\"alert alert-success\"><b> Total with due   : <span class='total-slog'>$updatedPrice tk</span></b></p>
                    </div>
    ...
    function cusInfoTrackingAfterClickingDataSend($name, $voucherNo,$payment,$paying,$discount,$totalBill)
    {
       // $payment = DB::table('sellingvoucher')->where('voucherNo', $voucherNo)->value('id');
        ...
        //Due data modifying for returning product

       $thisVoucherDue = $totalBill-$payment;

       if($thisVoucherDue>$currentPrice){
          $totalDue = DB::table('customer')->where('name', $cusName)->value('due');
           $cusPrevDue = $totalDue-$thisVoucherDue;
        ...
        $updatedPriceAfterReturn = ($currentPrice + $cusPrevDue) - $payment;

        if($paying==0 && $discount==0){
            DB::table('due')->update([
                'due' =>  $updatedPriceAfterReturn
            ]);
        }

        //Solving get or due problem ......
        $getOrdue = DB::table('customer')->where('name', $name)->value('due');

        $getOrdueAlert="";

        if($getOrdue<0){
            $getOrdue = -($getOrdue);
            $getOrdueAlert =  "<p class='alert alert-danger'><b>Client-Due : <span>$getOrdue tk</span></b></p>";

        }else{
            $getOrdueAlert =  "<p class='alert alert-danger'><b>Prev-Due : <span>$getOrdue tk</span></b></p>";
        }
        ...
        if ($updatedPriceAfterReturn > 0) {
            ...
            echo "
                    ...
                    <div class=\"prv - due\">
                        <p class='alert alert-warning'><b>Owner-get: <span> $updatedPriceAfterReturn tk</span></b></p>
                    </div>
        ...
        DB::table('due')->update([
            ...
            if($paying>$updatedPriceAfterDiscount){
                ...
                if ($finalPayment > 0) {
                    ...
                    <div class=\"total\">
                        <p class=\"alert alert-success\"><b> Current Price   : <span class='current-slog'>$priceAfterDiscount tk</span></b></p>
                    </div>
                    ...
                    <div class=\"total\">
                        <p class=\"alert alert-success\"><b> Total with due   : <span class='total-slog'>$updatedPriceAfterDiscount tk</span></b></p>
                    </div>
  ...
  */
    ...
    public function cusInfoTrackingAfterClickingDataSendforBrought($name, $voucher, $bill,$paying,$discount){
       ...
       // $currentPrice = DB::table("buyeditingcart")->sum('sellingPrice');

        //Due data modifying for returning product

        $totalBill = DB::table('buyingvoucher')->where('voucherNo',$voucher)->value('myBill');
        $payment = DB::table('buyingvoucher')->where('voucherNo',$voucher)->value('payment');
        ...
        if($thisVoucherDue>$bill){
            $totalDue = DB::table('seller')->where('name', $name)->value('get');
            $myPrevDue = $totalDue-$thisVoucherDue;
        ...
        $updatedPriceAfterReturn = ($bill + $myPrevDue) - $payment;
        ...
        //Solving get or due problem ......
        $getOrdue = DB::table('seller')->where('name', $name)->value('get');
        ...
        if ($updatedPriceAfterReturn > 0) {
            ...
            echo "
                    ...
                    <div class=\"total\">
                        <p class=\"alert alert-success\"><b> Current Price   : <span class='current-slog'>$bill tk</span></b></p>
                    </div>
                    ...
                    <div class=\"prv - due\">
                        <p class='alert alert-warning'><b>$name-get: <span> $updatedPriceAfterReturn tk</span></b></p>
                    </div>
        ...
        ";
            ...
            echo "
                    ...
                    <div class=\"prv - due\">
                        <p class='alert alert-warning'><b>I-get: <span> $updatedPriceAfterReturn tk</span></b></p>
                    </div>
